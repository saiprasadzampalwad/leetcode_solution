...
🟢 Easy  |  [View on LeetCode](https://leetcode.com/problems/check-if-matrix-is-x-matrix/)
...
### My Solution: [2319-Check-If-Matrix-Is-X-Matrix.java](./2319-Check-If-Matrix-Is-X-Matrix.java)
